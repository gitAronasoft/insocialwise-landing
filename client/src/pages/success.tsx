      ...
      <div className="pt-12 pb-8">
        <div className="container mx-auto px-6 text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center px-6 py-3 rounded-full bg-gradient-to-r from-yellow-100 to-yellow-200 text-yellow-800 text-lg font-semibold mb-12"
          >
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-xl rounded-3xl overflow-hidden h-full">
              <CardContent className="p-8">
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900">Your Account is Active!</h2>
                </div>
          ...
          >
            ...
            >
              ...
              <Link href="/">
                <Button
                  variant="outline"
                  className="w-full border-2 border-gray-300 hover:border-indigo-500 hover:text-indigo-600 py-4 text-lg rounded-xl transition-all duration-300"
                >
                  Return to Homepage
                </Button>
              </Link>
